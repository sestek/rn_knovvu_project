    ...
    return (
        <>
            <ScrollView style={{ flex: 1, paddingTop: 30, paddingHorizontal: 15 }}>
                <Text h3 h3Style={{ marginBottom: 8 }}>Knovvu is a registered trademark of <Text style={{ color: color_300 }}>Sestek.</Text></Text>
                ...
                <Text h4 h4Style={{ marginVertical: 8 }}>Call Us On</Text>
